...
public class FileUpAndDownController {
    ...
    public ResponseEntity<byte[]> testResponseEntity(HttpSession session) throws IOException {
        ...
        //获取服务器中文件的真实路径
        String realPath = servletContext.getRealPath("/static/img/keyboard.JPG");
        //创建输入流
        ...
        //设置要下载方式以及下载文件的名字
        headers.add("Content-Disposition", "attachment;filename=keyboard.jpg");
        //设置响应状态码
